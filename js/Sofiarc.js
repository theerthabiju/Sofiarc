(function ($) {
  ...
  function thmOwlInit() {
    // owl slider
    let sofiarcowlCarousel = $(".sofiarc-owl__carousel");
    if (sofiarcowlCarousel.length) {
      sofiarcowlCarousel.each(function () {
        let elm = $(this);
    ...
    let sofiarcowlCarouselNav = $(".sofiarc-owl__carousel--custom-nav");
    if (sofiarcowlCarouselNav.length) {
      sofiarcowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let sofiarcowlCarouselWithCounter = $(
      ".sofiarc-owl__carousel--with-counter"
    );
    if (sofiarcowlCarouselWithCounter.length) {
      sofiarcowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="sofiarc-owl__carousel__counter"><span class="sofiarc-owl__carousel__counter__current"></span> <span class="sofiarc-owl__carousel__counter__total"></span></div>'
            );
            elm
              .find(".sofiarc-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".sofiarc-owl__carousel__counter__total")
  ...
  function sofiarcSlickInit() {
    // slick slider
    let sofiarcslickCarousel = $(".sofiarc-slick__carousel");
    if (sofiarcslickCarousel.length) {
      sofiarcslickCarousel.each(function () {
        let elm = $(this);
        let options = elm.data("slick-options");
        let sofiarcslickCarousel = elm.slick(
          "object" === typeof options ? options : JSON.parse(options)
        );
      });
    }
  ...
  //Strech Column
  function sofiarc_stretch() {
    var i = $(window).width();
    $(".row .sofiarc-stretch-element-inside-column").each(function () {
      var $this = $(this),
